...
new TypeIt("#teks2", {
  strings: ["Ya employee ki taraf sa:- ","Happy Birthday Prachi Madam ji🫡🫡."
    ," ",
   "Ya Haryanvi ki taraf sa:-","Janamdin ki ghani badhaai🤌🧿🎂🎂🍫."
   ," ",
   "Ya Gujarat ki taraf sa:- ","હેપ્પી બર્થ ડે ટુ મેરી પ્રાચી ખુશ રહો હું હંમેશા તમારી સાથે છું🤗🎂🎂🍫."
   ," ",
  "Ya aapko pasand karta hai uski taraf sa:-", "Happy Birthday Mari pasandidar aurat Mari Prachi JI 🎂🤗🌸🌺🌷🌹."
  ," ",
...
new TypeIt("#trims", {
  strings: ["Thank You Madam JI For Everything"],
  startDelay: 1000,
  speed: 75,
  loop: false,
  waitUntilVisible: true,
